...
{
    public class EmployeeLinks(LinkGenerator linkGenerator, IDataShaper<EmployeeDto> dataShaper)
    {
        ...
        private bool ShouldGenerateLinks(HttpContext httpContext)
        {
            ...
            // Extract the subtype from the MediaType property
            var subType = mediaType.MediaType.Split('/')[1];
